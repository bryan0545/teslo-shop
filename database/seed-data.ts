...
export const initialData: SeedData = {
  users: [
    { name: 'Bryan Rodas Collazos', email: 'bryan@google.com', password: bcrypt.hashSync('123456'), role: 'admin' },
    { name: 'Robert Rodas Collazos', email: 'robert@google.com', password: bcrypt.hashSync('123456'), role: 'admin' },
    { name: 'Ramiro Rodas', email: 'ramiro@google.com', password: bcrypt.hashSync('123456'), role: 'client' },
  ],
  products: [
    {
      description:
